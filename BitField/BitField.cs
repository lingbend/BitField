...
namespace BitField
{
    ...
    public struct BitField
    {
        ...
        public BitField(BitField old_grid)
        {
            _border_num = 1;
        ...
        public void CombineGrids(IEnumerable<BitField> other_grids)
        {
        ...
        public void DifferenceGrids(IEnumerable<BitField> other_grids)
        {
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                return ((BitField) obj)._grid.Equals(_grid);
            }
