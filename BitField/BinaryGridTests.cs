namespace BitField
{
    ...
    public class BitFieldTests
    {
        ...
        {
            BitField grid = new BitField(5, 5);
        ...
        public void BitFieldChangeBorders_1SameFullGraph_Valid()
        {
            ...
            grid.ChangeBorders(1);
            BitField testGrid = new BitField(5, 5);
        ...
        public void BitFieldInsertRow_NormalSizeEmptyGraph_Valid()
        {
            ...
            grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1000001_1111111);
            grid.InsertRow(2);
            BitField test_grid = new BitField(6, 5);
        ...
        [TestMethod]
        public void BitFieldInsertRow_1WideGrid_Valid()
        {
            BitField grid = new BitField(5, 1);
            grid.InsertRow(1);
            BitField test_grid = new BitField(6, 1);
            test_grid._grid = ToBinaryNumber(0b111_101_101_101_101_101_101_111);
            Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        } 

        [TestMethod]
        public void BitFieldInsertRow_1HighGrid_Valid()
        {
            BitField grid = new BitField(1, 5);
            grid.InsertRow(1);
            BitField test_grid = new BitField(2, 5);
            test_grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1111111);
            Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        } 

        [TestMethod]
        public void BitFieldInsertRow_1WideGrid_Invalid()
        {
            BitField grid = new BitField(5, 1);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.InsertRow(6));
            grid = new BitField(5, 1);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.InsertRow(0));
            grid = new BitField(5, 1);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.InsertRow(7));
        } 
        ...
        [TestMethod]
        public void BitFieldInsertRow_1HighGrid_Invalid()
        {
            BitField grid = new BitField(1, 5);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.InsertRow(0));
            grid = new BitField(1, 5);
        ...
        public void BitFieldInsertCol_NormalSizeEmptyGraph_Valid()
        {
            ...
            grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1000001_1111111);
            grid.InsertCol(2);
            BitField test_grid = new BitField(5, 6);
        ...
        [TestMethod]
        public void BitFieldInsertCol_1WideGrid_Valid()
        {
            BitField grid = new BitField(5, 1);
            grid.InsertCol(1);
            BitField test_grid = new BitField(5, 2);
            test_grid._grid = ToBinaryNumber(0b1111_1001_1001_1001_1001_1001_1111);
            Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        } 

        [TestMethod]
        public void BitFieldInsertCol_1HighGrid_Valid()
        {
            BitField grid = new BitField(1, 5);
            grid.InsertCol(1);
            BitField test_grid = new BitField(1, 6);
            test_grid._grid = ToBinaryNumber(0b11111111_10000001_11111111);
            Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        } 

        [TestMethod]
        public void BitFieldInsertCol_1WideGrid_Invalid()
        {
            BitField grid = new BitField(5, 1);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.InsertCol(0));
            grid = new BitField(5, 1);
        ...
        [TestMethod]
        public void BitFieldInsertCol_1HighGrid_Invalid()
        {
            BitField grid = new BitField(1, 5);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.InsertCol(0));
            grid = new BitField(1, 5);
        ...
        public void BitFieldDeleteRow_NormalSizeEmptyGraph_Valid()
        {
            ...
            grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1000001_1111111);
            grid.DeleteRow(2);
            BitField test_grid = new BitField(4, 5);
        ...
        [TestMethod]
        public void BitFieldDeleteRow_1WideGrid_Valid()
        {
            BitField grid = new BitField(5, 1);
            grid.DeleteRow(1);
            BitField test_grid = new BitField(4, 1);
            test_grid._grid = ToBinaryNumber(0b111_101_101_101_101_111);
            Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        } 

        [TestMethod]
        public void BitFieldDeleteRow_1WideGrid_Invalid()
        {
            BitField grid = new BitField(5, 1);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.DeleteRow(6));
            grid = new BitField(5, 1);
        ...
        [TestMethod]
        public void BitFieldDeleteRow_1HighGrid_Invalid()
        {
            BitField grid = new BitField(1, 5);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.DeleteRow(0));
            grid = new BitField(1, 5);
        ...
        public void BitFieldDeleteCol_NormalSizeEmptyGraph_Valid()
        {
            ...
            grid._grid = ToBinaryNumber(0b1111111_1000001_1000001_1000001_1000001_1000001_1111111);
            grid.DeleteCol(2);
            BitField test_grid = new BitField(5, 4);
        ...
        public void BitFieldDeleteCol_NormalSizeAlternatingGraph_Valid()
        {
            ...
            grid.DeleteCol(2);
            BitField test_grid = new BitField(4, 4);
        ...
        [TestMethod]
        public void BitFieldDeleteCol_1HighGrid_Valid()
        {
            BitField grid = new BitField(1, 5);
            grid.DeleteCol(1);
            BitField test_grid = new BitField(1, 4);
            test_grid._grid = ToBinaryNumber(0b111111_100001_111111);
            Assert.AreEqual(test_grid, grid, $"test grid: {BinaryNumberToLong(test_grid._grid).ToString("b")} grid: {BinaryNumberToLong(grid._grid ).ToString("b")}");
        } 

        [TestMethod]
        public void BitFieldDeleteCol_1WideGrid_Invalid()
        {
            BitField grid = new BitField(5, 1);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.DeleteCol(0));
            grid = new BitField(5, 1);
        ...
        [TestMethod]
        public void BitFieldDeleteCol_1HighGrid_Invalid()
        {
            BitField grid = new BitField(1, 5);
            Assert.Throws<IndexOutOfRangeException>(()=>grid.DeleteCol(0));
            grid = new BitField(1, 5);
        ...
        [TestMethod]
        public void BitFieldSetGetSlice_1by1Grid_Valid()
        {
            BitField grid = new BitField(1, 1);
            grid.SetSlice(1, 1, 1, 1, 1);
            BitField test_grid = new BitField(1, 1);
