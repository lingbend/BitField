...
`BitField` is a highly performant C# library for managing 2D bitfields. Engineered for speed and memory efficiency, it is designed for high-frequency applications like real-time cellular automata, large-scale procedural generation, and complex 2D boolean grid analysis.
